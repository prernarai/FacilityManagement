package com.company.facilitymanagement;
...
public class FacilitymanagementTestContainer extends TestContainer {

    public FacilitymanagementTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/facilitymanagement/app.properties",
    ...
    public static class Common extends FacilitymanagementTestContainer {

        public static final FacilitymanagementTestContainer.Common INSTANCE = new FacilitymanagementTestContainer.Common();
